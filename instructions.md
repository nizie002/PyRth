...
- **Conversion Modes**: Supports multiple modes (e.g., TDIM, t3ster, temp, volt) for flexibility.
...
- **`Evaluation` Class**: Orchestrates the overall analysis process.
  ...
  - Methods:
    ...
    - `save_all_figures`: Saves all generated figures to PNG files.

    - `modules_output`: Processes and saves output data for all modules.
